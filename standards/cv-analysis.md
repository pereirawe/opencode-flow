...
`gap-analysis.md` and `inferences.md`, plus their HTML/PDF renders. Every
career analysis report MUST conform to this standard so outputs are
predictable for the candidate and comparable across runs.
...
2. **Allowed in internal analysis artifacts only** — hub.json,
   profile-analysis.md, gap-analysis.md, inferences.md (and their HTML/PDF
   renders, which are reading/analysis artifacts, not ATS-submitted).

...
- **Commit the changes** to `known_issues.md` and `resolved_issues.md` after
  archiving. Stage files explicitly:
...
- **Push the commit** to the remote. Detect the current branch via
  `git branch --show-current` and push to it.

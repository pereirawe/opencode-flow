...
permission:
  ...
  bash:
    ...
    "find * -exec*": deny
---
First load the locale-loader skill to get locale-appropriate standards (issues.md). Load `standards/code-review/frontend.md` via locale-loader skill before reviewing.

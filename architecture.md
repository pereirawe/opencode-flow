...
- **Prioritization proposals**: PO registers proposals in `.opencode/prioritization.md` (project-level) or `~/.config/opencode/prioritization.md` (global fallback) before promoting to `known_issues.md`

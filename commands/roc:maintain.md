...
---
description: Maintain known_issues.md and wip/list.md — sync, archive, clean
---

Full maintenance of the two tracker files: `known_issues.md` and `wip/list.md`.
...
4. **Sync `wip/list.md`** — update the issues table, remove stale sections, refresh order suggestion
5. **Report** — summarize what was archived, updated, and skipped
...
Update issue references in `wip/list.md` table to match.
...
[maintain] WIP list: synced, 2 sections removed
```
...
- `wip/list.md` updates require assistant judgment (which sections to prune)
